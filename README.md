...
* Below are the [key members](https://www.vechain.com/about) of the VeChain organization and brief background on each member, highlighting the expertise that VeChains founding members brought together to build out the VeChain enterprise:
  ...
  * Jianliang Gu - Chief Technology Officer 
      * 16 years experience in both hardware and software embedded system development and IT management. Joining VeChain in 2017, he is in charge of tech development, enterprise blockchain solutions, and IoT (Internet of Things) technologies.
...
* The system of master nodes centralizes voting rights in a decentralized system. Critiscm can be made of this, given the advancement of blockchain is heralded for its decentralization.  The fact that VeChain caters to business's that require a differentiated level of service, allowing business to monitor the item or physical inventory they sell as the item is en route to verify its condition and authenticity, preferes a centralized, trusted authority with that data.
...
* Another industry is within the manufacture and imports of natural gas.  One of the largest problems facing this industry is [being able to produce more energy at lower cost with less emissions](https://www.hellenicshippingnews.com/challenges-and-trends-for-the-oil-and-gas-industry/). Trends within this industry have yielded a global community push for goverments to adopt a carbon credit / carbon tax initiatives. These initiatves have solutions within blockchain technology that offer businesses the capability to offset carbon output and earn certified government credits.
...
* VeChain is working within many different industries. Vechain, unlike some competitors named earlier, may find it more difficult to deliver results for every niche.  My recommendation for VeChain is to begin carving out unique assets within a smaller niche to gain market dominance.  Another recommendation would be to extend from the current model of the authorized nodes, in which stakeholders monitoring the data are the users and beneficiaries of owning a node.  It may be more advantageous to offer the same benefit to the public.  This may create a more decentralized system, lending to the security of the network. In current state, if one masternode had a bad actor they could then manipulate a block. This should be caught by other nodes in the current system, however it may not be the case due to the limited number of master nodes able to detect an attack on the network. This does not mean that VeChain should eliminate their Know-Your-Clients (KYC); in fact, it may mean enhancing their KYC and upgrading to account for citizen owned master nodes. This would increase the systems safety overall. 
